...
__export(src_exports, {
  ...
  closeSharedFetch: () => closeSharedFetch,
...
function sharedFetch(input, init) {
  ...
  return (0, import_undici.fetch)(input, undiciInit);
}
async function closeSharedFetch() {
...
var RequestManager = class {
  ...
  buildBody(options) {
    if (options.files?.length) {
      const payload = options.body !== void 0 && typeof options.body === "object" && options.body !== null && !(options.body instanceof import_undici3.FormData) ? options.body : {};
      return buildFormData(payload, options.files);
    }
    if (options.body === void 0) return void 0;
    if (options.body instanceof import_undici3.FormData) return options.body;
  ...
  buildHeaders(options, body, route) {
    ...
    if (body !== void 0 && !(body instanceof import_undici3.FormData)) {
...
var REST = class extends import_node_events.EventEmitter {
  ...
  async get(route, options) {
    return this.requestManager.request("GET", route, options);
  }
  async post(route, options) {
    return this.requestManager.request("POST", route, options);
  }
  async patch(route, options) {
    return this.requestManager.request("PATCH", route, options);
  }
  async put(route, options) {
    return this.requestManager.request("PUT", route, options);
  }
  async delete(route, options) {
    return this.requestManager.request("DELETE", route, options);
  }
  static get Routes() {
