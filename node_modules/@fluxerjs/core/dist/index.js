...
__export(src_exports, {
  ...
  AttachmentBuilder: () => import_builders5.AttachmentBuilder,
  AuditLogActionType: () => import_types40.AuditLogActionType,
  BETA_CLIENT_CLUSTER_WARNING: () => BETA_CLIENT_CLUSTER_WARNING,
  Base: () => Base,
  CDN_URL: () => CDN_URL,
  ...
  ChannelType: () => import_types40.ChannelType,
  Client: () => Client,
  ClientCluster: () => ClientCluster,
  ClientClusterEvents: () => ClientClusterEvents,
  ClientUser: () => ClientUser,
  ContentWarningLevel: () => import_types40.ContentWarningLevel,
  DEFAULT_CACHE_LIMITS: () => DEFAULT_CACHE_LIMITS,
  DEFAULT_INSTANCE_ENDPOINTS: () => DEFAULT_INSTANCE_ENDPOINTS,
  DMChannel: () => DMChannel,
  EmbedBuilder: () => import_builders5.EmbedBuilder,
  ErrorCodes: () => import_util2.ErrorCodes,
  Events: () => Events,
  FluxerError: () => import_util3.FluxerError,
  GatewayOpcodes: () => import_types40.GatewayOpcodes,
  Guild: () => Guild,
  GuildBan: () => GuildBan,
  ...
  GuildMemberProfileFlags: () => import_types40.GuildMemberProfileFlags,
  GuildMemberRoleManager: () => GuildMemberRoleManager,
  GuildNSFWLevel: () => import_types40.GuildNSFWLevel,
  GuildOperations: () => import_types40.GuildOperations,
  GuildSticker: () => GuildSticker,
  Invite: () => Invite,
  InviteType: () => import_types40.InviteType,
  LinkChannel: () => LinkChannel,
  Message: () => Message,
  MessageAttachmentFlags: () => import_types40.MessageAttachmentFlags,
  MessageCollector: () => MessageCollector,
  MessageFlags: () => import_types40.MessageFlags,
  MessageFlagsBitField: () => import_util21.MessageFlagsBitField,
  MessageFlagsBits: () => import_util21.MessageFlagsBits,
  MessageManager: () => MessageManager,
  MessagePayload: () => import_builders5.MessagePayload,
  MessageReaction: () => MessageReaction,
  MessageReferenceType: () => import_types40.MessageReferenceType,
  MessageType: () => import_types40.MessageType,
  OverwriteType: () => import_types40.OverwriteType,
  PackManager: () => PackManager,
  PermissionFlags: () => import_util21.PermissionFlags,
  PermissionsBitField: () => import_util21.PermissionsBitField,
  PublicUserFlags: () => import_types40.PublicUserFlags,
  ReactionCollector: () => ReactionCollector,
  RelationshipType: () => import_types40.RelationshipType,
  Role: () => Role,
  Routes: () => import_types40.Routes,
  STATIC_CDN_URL: () => STATIC_CDN_URL,
  SplashCardAlignment: () => import_types40.SplashCardAlignment,
  SystemChannelFlags: () => import_types40.SystemChannelFlags,
  TextChannel: () => TextChannel,
  User: () => User,
  UserFlagsBitField: () => import_util21.UserFlagsBitField,
  UserFlagsBits: () => import_util21.UserFlagsBits,
  ...
  cdnEmojiURL: () => cdnEmojiURL,
  cdnGuildAssetURL: () => cdnGuildAssetURL,
  cdnMemberAvatarURL: () => cdnMemberAvatarURL,
  cdnMemberBannerURL: () => cdnMemberBannerURL,
  cdnStickerURL: () => cdnStickerURL,
  createLogger: () => import_util21.createLogger,
  inviteUrl: () => inviteUrl,
  normalizeApiOrigin: () => normalizeApiOrigin,
  normalizeCacheLimit: () => normalizeCacheLimit,
  parseInstanceDiscovery: () => parseInstanceDiscovery,
  parsePrefixCommand: () => import_util21.parsePrefixCommand,
  parseUserMention: () => import_util21.parseUserMention,
  resolveCacheLimits: () => resolveCacheLimits,
  resolveInstanceEndpoints: () => resolveInstanceEndpoints,
  resolveKlipyToImageUrl: () => import_util21.resolveKlipyToImageUrl,
  resolvePermissionsToBitfield: () => import_util21.resolvePermissionsToBitfield,
  serializeError: () => import_util21.serializeError,
  toAttachmentUploadCompleteBody: () => toAttachmentUploadCompleteBody,
  toAttachmentUploadPlanBody: () => toAttachmentUploadPlanBody,
  toBulkFetchWire: () => toBulkFetchWire,
  toChannelEditBody: () => toChannelEditBody,
  toChannelInviteBody: () => toChannelInviteBody,
  toDiscoveryApplicationPayload: () => toDiscoveryApplicationPayload,
  toDiscoveryBody: () => toDiscoveryBody,
  toDiscoveryStatusPayload: () => toDiscoveryStatusPayload,
  toEmojiCreateBody: () => toEmojiCreateBody,
  toEmojiEditBody: () => toEmojiEditBody,
  toMemberEditBody: () => toMemberEditBody,
  toMemberSearchBody: () => toMemberSearchBody,
  toMessageAttachmentEditWire: () => toMessageAttachmentEditWire,
  toPackInviteBody: () => toPackInviteBody,
  toPackSummaryPayload: () => toPackSummaryPayload,
  toPresenceWire: () => toPresenceWire,
  toProfilePayload: () => toProfilePayload,
  toStickerCreateBody: () => toStickerCreateBody,
  toStickerEditBody: () => toStickerEditBody,
  toSudoBody: () => toSudoBody
});
module.exports = __toCommonJS(src_exports);
var import_builders5 = require("@fluxerjs/builders");
var import_types40 = require("@fluxerjs/types");
var import_util21 = require("@fluxerjs/util");
...
function toRoleRequestBody(options) {
  ...
  if (options.permissions !== void 0) {
    body.permissions = typeof options.permissions === "string" ? options.permissions : (0, import_util.resolvePermissionsToBitfield)(options.permissions);
  }
  return body;
}
...
async function fetchFileBuffer(url, index) {
  if (!URL.canParse(url)) {
    throw new import_util3.FluxerError(`Invalid file URL at index ${index}: ${url}`, {
      code: import_util2.ErrorCodes.InvalidFileUrl
    });
  }
  let res;
  try {
    ...
    throw new import_util3.FluxerError(`Failed to fetch file from ${url}`, {
      code: import_util2.ErrorCodes.FileFetchFailed,
      cause: err instanceof Error ? err : void 0
    });
  }
  if (!res.ok) {
    throw new import_util3.FluxerError(`Failed to fetch file from ${url}: ${res.status} ${res.statusText}`, {
      code: import_util2.ErrorCodes.FileFetchFailed
    });
  }
...
async function resolveMessageFiles(files) {
  ...
  for (let i = 0; i < files.length; i++) {
    ...
    if ("url" in f && f.url) {
      ...
      throw new import_util3.FluxerError(`File at index ${i} must have either "data" or "url"`, {
        code: import_util2.ErrorCodes.InvalidAttachment
      });
    }
  }
  return result;
...
function toMessageReference(target, forceForward = false) {
  ...
  const type = forceForward ? import_types.MessageReferenceType.Forward : target.type ?? import_types.MessageReferenceType.Default;
  if (type !== import_types.MessageReferenceType.Default) ref.type = type;
...
async function prepareMessagePostPayload(options, defaults) {
  let normalized = options instanceof import_builders.MessagePayload ? messagePayloadToSendOptions(options) : options;
  if (typeof normalized === "string") {
    if (normalized.length === 0) {
      throw new import_util3.FluxerError("Cannot send an empty message", { code: import_util2.ErrorCodes.EmptyMessage });
    }
  ...
  if (files?.length && uploadedAttachments?.length) {
    throw new import_util3.FluxerError("Cannot combine multipart files with uploadedAttachments", {
      code: import_util2.ErrorCodes.InvalidMessageOptions
    });
  }
  if (replyTo && forward) {
    throw new import_util3.FluxerError("Cannot combine replyTo and forward", {
      code: import_util2.ErrorCodes.InvalidMessageOptions
    });
  }
  ...
  if (forward) {
    if (!forward.channelId || !forward.messageId) {
      throw new import_util3.FluxerError("forward requires channelId and messageId", {
        code: import_util2.ErrorCodes.InvalidMessageOptions
      });
    }
...
// src/Helpers/MessageUtils/Types.ts
var AllowedMentions = {
  suppressReplyPing: { repliedUser: false },
  none: { parse: [] },
...
function httpStatus(err) {
  if (err instanceof import_rest.FluxerAPIError) return err.statusCode;
...
function rethrowMapped(err, options) {
  ...
  if (err instanceof import_util3.FluxerError) throw err;
  if (options.notFound && httpStatus(err) === 404) {
    throw new import_util3.FluxerError(options.notFound.message, {
      code: options.notFound.code,
      cause: err
    });
  }
  throw new import_util3.FluxerError(errorMessage(err, options.fallback), {
    code: options.code,
    cause: err
  });
}
  ...
  async fetchMessage() {
    try {
      const data = await this.client.rest.get(
        import_types2.Routes.channelMessage(this.channelId, this.messageId)
      );
      return new Message(this.client, data);
    } catch (err) {
      rethrowMapped(err, {
        notFound: {
          code: import_util2.ErrorCodes.MessageNotFound,
...
// src/Helpers/ReactionCollector.ts
var ReactionCollector = class extends import_node_events.EventEmitter {
  client;
  messageId;
  channelId;
  options;
...
function toReactionEmoji(emoji) {
  ...
  const parsed = (0, import_util4.parseEmoji)(emoji);
  if (parsed?.id) {
    return {
      name: parsed.name,
      id: parsed.id,
...
async function reactToMessage(message, emoji) {
  ...
  await message.client.rest.put(
    import_types3.Routes.channelMessageReactionMe(message.channelId, message.id, wire)
  );
...
async function removeMessageReaction(message, emoji, userId) {
  ...
  const route = userId ? import_types3.Routes.channelMessageReactionUser(message.channelId, message.id, e, userId) : import_types3.Routes.channelMessageReactionMe(message.channelId, message.id, e);
  await message.client.rest.delete(route);
}
async function removeAllMessageReactions(message) {
  await message.client.rest.delete(import_types3.Routes.channelMessageReactions(message.channelId, message.id));
}
async function removeMessageReactionEmoji(message, emoji) {
  const e = await emojiPath(message, emoji);
  await message.client.rest.delete(import_types3.Routes.channelMessageReaction(message.channelId, message.id, e));
}
...
async function fetchMessageReactionUsersPage(message, emoji, options) {
  ...
  const route = import_types3.Routes.channelMessageReactionUsers(message.channelId, message.id, e) + (qs2 ? `?${qs2}` : "");
...
function toSendOptions(content) {
  ...
  if (content instanceof import_builders2.MessagePayload) return messagePayloadToSendOptions(content);
  return { ...content };
}
...
async function sendPrepared(message, payload) {
  const data = await message.client.rest.post(
    import_types4.Routes.channelMessages(message.channelId),
    payload
  );
...
var Message = class _Message extends Base {
  ...
  constructor(client, data) {
    ...
    this.type = data.type ?? import_types5.MessageType.Default;
  ...
  async edit(options) {
    ...
    if (options.embeds?.length) {
      body.embeds = options.embeds.map(
        (e) => e instanceof import_builders3.EmbedBuilder ? e.toJSON() : e
      );
    }
    ...
    const data = await this.client.rest.patch(import_types5.Routes.channelMessage(this.channelId, this.id), {
      body
    });
  ...
  /** Delete this message. */
  async delete() {
    await this.client.rest.delete(import_types5.Routes.channelMessage(this.channelId, this.id));
    this.client._removeMessageFromCache(this.channelId, this.id);
  }
  /** Delete a specific attachment from this message. */
  async deleteAttachment(attachmentId) {
    await this.client.rest.delete(
      import_types5.Routes.channelMessageAttachment(this.channelId, this.id, attachmentId),
      { auth: true }
    );
  ...
  async pin() {
    await this.client.rest.put(import_types5.Routes.channelPinMessage(this.channelId, this.id));
    this.pinned = true;
  }
  /** Unpin this message from the channel. */
  async unpin() {
    await this.client.rest.delete(import_types5.Routes.channelPinMessage(this.channelId, this.id));
    this.pinned = false;
  }
...
function validateBulkMessageFetchRequests(requests) {
  ...
  if (requests.length < req.min || requests.length > req.max) {
    throw new import_util3.FluxerError(`bulkFetchMessages requires between ${req.min} and ${req.max} requests`, {
      code: import_util2.ErrorCodes.InvalidFetchLimit
    });
  }
  let total = 0;
  for (const request of requests) {
    if (request.limit < limit.min || request.limit > limit.max) {
      throw new import_util3.FluxerError(
  ...
  if (total > totalMax) {
    throw new import_util3.FluxerError(`bulkFetchMessages total message limit must not exceed ${totalMax}`, {
      code: import_util2.ErrorCodes.InvalidFetchLimit
    });
  }
}
var MessageManager = class {
  ...
  async fetchOne(messageId) {
    try {
      const data = await this.client.rest.get(
        import_types6.Routes.channelMessage(this.channelId, messageId)
      );
  ...
  async fetchMany(options) {
    if (options.limit != null && (options.limit < 1 || options.limit > 100)) {
      throw new import_util3.FluxerError("limit must be between 1 and 100", {
        code: import_util2.ErrorCodes.InvalidFetchLimit
      });
    }
    ...
    const base = import_types6.Routes.channelMessages(this.channelId);
    const data = await this.client.rest.get(qs2.size > 0 ? `${base}?${qs2}` : base);
    const collection = new import_collection3.Collection();
...
async function putBlob(url, body, contentType) {
  ...
  if (!res.ok) {
    throw new import_util3.FluxerError(`Presigned upload failed: ${res.status}`, {
      code: import_util2.ErrorCodes.AttachmentUploadFailed
    });
  }
}
async function uploadAttachmentsForSend(client, channelId, files) {
  const plan = await client.rest.post(
    import_types7.Routes.channelAttachments(channelId),
    {
      body: {
  ...
  for (const item of plan.attachments) {
    ...
    if (!file) {
      throw new import_util3.FluxerError(`No file data for planned attachment id ${item.id}`, {
        code: import_util2.ErrorCodes.InvalidAttachmentInput
      });
    }
  ...
  if (multipart.length) {
    await client.rest.post(import_types7.Routes.channelAttachmentsComplete(channelId), {
...
var Channel = class extends Base {
  ...
  get createdTimestamp() {
    return import_util5.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this channel was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util5.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  /**
  ...
  isDM() {
    return this.type === import_types8.ChannelType.DM || this.type === import_types8.ChannelType.GroupDM || this.type === import_types8.ChannelType.DMPersonalNotes;
  }
  /** Check if this is a personal notes channel. */
  isPersonalNotes() {
    return this.type === import_types8.ChannelType.DMPersonalNotes;
  }
  ...
  async bulkDelete(countOrIds) {
    ...
    if (typeof countOrIds === "number") {
      if (!Number.isInteger(countOrIds) || countOrIds < 1 || countOrIds > 100) {
        throw new import_util3.FluxerError("bulkDelete count must be between 1 and 100", {
          code: import_util2.ErrorCodes.InvalidBulkDelete
        });
      }
      ids = [
    ...
    if (ids.length === 1) {
      await this.client.rest.delete(import_types8.Routes.channelMessage(this.id, ids[0]), { auth: true });
      this.client._removeMessageFromCache(this.id, ids[0]);
      return ids;
    }
    if (ids.length > 100) {
      throw new import_util3.FluxerError("bulkDelete requires at most 100 message IDs", {
        code: import_util2.ErrorCodes.InvalidBulkDelete
      });
    }
    await this.client.rest.post(import_types8.Routes.channelBulkDelete(this.id), {
  ...
  async bulkDeleteMyMessages(options) {
    ...
    await this.client.rest.post(import_types8.Routes.channelBulkDeleteMine(this.id), {
  ...
  async acknowledgePins() {
    await this.client.rest.post(import_types8.Routes.channelPinsAck(this.id), { auth: true });
  }
  /** Clear the read state for this channel. */
  async clearReadState() {
    await this.client.rest.delete(import_types8.Routes.channelMessagesAck(this.id), { auth: true });
  }
  ...
  async requestAttachmentUploads(attachments) {
    const data = await this.client.rest.post(
      import_types8.Routes.channelAttachments(this.id),
      {
  ...
  async completeAttachmentUploads(uploads) {
    const data = await this.client.rest.post(
      import_types8.Routes.channelAttachmentsComplete(this.id),
      {
  ...
  async sendTyping() {
    await this.client.rest.post(import_types8.Routes.channelTyping(this.id), { auth: true });
  }
  /** Fetch available RTC regions for voice channels. */
  async fetchRtcRegions() {
    const data = await this.client.rest.get(import_types8.Routes.channelRtcRegions(this.id), {
      auth: true
    });
  ...
  async fetchSlowmode() {
    const data = await this.client.rest.get(
      import_types8.Routes.channelSlowmode(this.id),
      { auth: true }
    );
    return {
...
var MessageCollector = class extends import_node_events2.EventEmitter {
  client;
  channelId;
  options;
  collected = new import_collection4.Collection();
  _timeout = null;
  _ended = false;
  _listener;
...
async function fetchPinnedMessagesPageFor(client, channelId, options) {
  ...
  const data = await client.rest.get(
    import_types9.Routes.channelPins(channelId) + (qs2 ? `?${qs2}` : "")
  );
...
function TextCapable(Base2) {
  class TextCapableChannel extends Base2 {
    ...
    async send(options) {
      ...
      const data = await this.client.rest.post(import_types9.Routes.channelMessages(this.id), payload);
...
var DMChannel = class extends TextCapable(Channel) {
  ...
  async purgeMessages() {
    if (this.type !== import_types10.ChannelType.DMPersonalNotes) {
      throw new import_util3.FluxerError("purgeMessages is only available on personal notes channels", {
        code: import_util2.ErrorCodes.InvalidChannelType
      });
    }
    const data = await this.client.rest.post(
      import_types10.Routes.channelMessagesPurge(this.id),
      { auth: true }
    );
  ...
  async pinInList() {
    await this.client.rest.put(import_types10.Routes.userMeChannelPin(this.id), { auth: true });
  }
  /** Unpin this DM channel from the DM list. */
  async unpinFromList() {
    await this.client.rest.delete(import_types10.Routes.userMeChannelPin(this.id), { auth: true });
  }
  /** Add a user to this group DM. */
  async addRecipient(userId) {
    await this.client.rest.put(import_types10.Routes.channelRecipient(this.id, userId), { auth: true });
  ...
  async removeRecipient(userId, options) {
    const url = import_types10.Routes.channelRecipient(this.id, userId) + (options?.silent ? "?silent=true" : "");
...
function requireString(obj, key, path) {
  ...
  if (typeof value !== "string" || value.length === 0) {
    throw new import_util3.FluxerError(`Invalid instance discovery: ${path}.${key} must be a non-empty string`, {
      code: import_util2.ErrorCodes.InvalidInstanceDiscovery
    });
  }
  return value;
}
...
function parseInstanceDiscovery(raw) {
  if (!(0, import_util6.isRecord)(raw)) {
    throw new import_util3.FluxerError("Invalid instance discovery: expected an object", {
      code: import_util2.ErrorCodes.InvalidInstanceDiscovery
    });
  }
  if (typeof raw.api_code_version !== "number" || !Number.isFinite(raw.api_code_version)) {
    throw new import_util3.FluxerError("Invalid instance discovery: api_code_version must be a number", {
      code: import_util2.ErrorCodes.InvalidInstanceDiscovery
    });
  }
  if (!(0, import_util6.isRecord)(raw.endpoints)) {
    throw new import_util3.FluxerError("Invalid instance discovery: endpoints must be an object", {
      code: import_util2.ErrorCodes.InvalidInstanceDiscovery
    });
  }
  const endpoints = {};
...
function resolveInstanceEndpoints(input) {
  ...
  const isFull = "endpoints" in input && (0, import_util6.isRecord)(input.endpoints) && typeof input.api_code_version === "number";
  if (isFull) {
...
function resolveRestApi(instanceApi, restApi) {
  ...
  if (fromRest !== fromInstance) {
    throw new import_util3.FluxerError(
      ...
      { code: import_util2.ErrorCodes.ConflictingInstanceConfig }
    );
  }
  return fromInstance;
}
...
function parseInviteCode(codeOrUrl) {
  ...
  if (!input) {
    throw new import_util3.FluxerError("Invite code cannot be empty", { code: import_util2.ErrorCodes.InvalidInvite });
  }
  const fromUrl = (value) => {
  ...
  if (!code || /[\s/?#]/.test(code)) {
    throw new import_util3.FluxerError("Invalid invite code or URL", { code: import_util2.ErrorCodes.InvalidInvite });
  }
  return code;
}
var Invite = class _Invite extends Base {
  ...
  constructor(client, data) {
    ...
    this.code = data.code;
    this.type = data.type;
    this.guild = (0, import_types11.isGuildInvite)(data) ? data.guild : null;
    this.channel = (0, import_types11.isGuildInvite)(data) || (0, import_types11.isGroupDmInvite)(data) ? data.channel : null;
    this.pack = (0, import_types11.isPackInvite)(data) ? data.pack : null;
    this.inviter = data.inviter ? client.getOrCreateUser(data.inviter) : null;
    this.memberCount = (0, import_types11.isPackInvite)(data) ? null : data.member_count ?? null;
    this.presenceCount = (0, import_types11.isGuildInvite)(data) ? data.presence_count ?? null : null;
  ...
  isGuild() {
    return this.type === import_types11.InviteType.Guild;
  }
  isGroupDM() {
    return this.type === import_types11.InviteType.GroupDM;
  }
  isPack() {
    return this.type === import_types11.InviteType.EmojiPack || this.type === import_types11.InviteType.StickerPack;
  }
  ...
  static async fetch(client, codeOrUrl) {
    const data = await client.rest.get(import_types11.Routes.invite(parseInviteCode(codeOrUrl)));
    return new _Invite(client, data);
  }
  /** Delete this invite. Requires Manage Guild or Create Instant Invite. */
  async delete() {
    await this.client.rest.delete(import_types11.Routes.invite(this.code), { auth: true });
  }
};

// src/Domain/Webhook.ts
var import_builders4 = require("@fluxerjs/builders");
...
var Webhook = class _Webhook extends Base {
  ...
  get createdTimestamp() {
    return import_util7.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this webhook was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util7.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  /** Delete this webhook (token auth when available, otherwise bot auth). */
  async delete() {
    if (this.token) {
      await this.client.rest.delete(import_types12.Routes.webhookExecute(this.id, this.token), { auth: false });
      return;
    }
    await this.client.rest.delete(import_types12.Routes.webhook(this.id), { auth: true });
  }
  /**
  ...
  async edit(options) {
    ...
    const data = this.token ? await this.client.rest.patch(import_types12.Routes.webhookExecute(this.id, this.token), {
      body,
      auth: false
    }) : await this.client.rest.patch(import_types12.Routes.webhook(this.id), { body, auth: true });
  ...
  async send(options, wait = false) {
    ...
    const route = `${import_types12.Routes.webhookExecute(this.id, token)}${wait ? "?wait=true" : ""}`;
  ...
  async editMessage(messageId, options) {
    ...
    if (options.embeds !== void 0) {
      body.embeds = options.embeds.map((e) => e instanceof import_builders4.EmbedBuilder ? e.toJSON() : e);
    }
    if (options.attachments !== void 0) {
      body.attachments = toMessageAttachmentEditWire(options.attachments);
    }
  ...
  static async fetch(client, webhookId) {
    const data = await client.rest.get(import_types12.Routes.webhook(webhookId));
  ...
  requireToken() {
    if (!this.token) {
      throw new import_util3.FluxerError(
        ...
        { code: import_util2.ErrorCodes.WebhookTokenRequired }
      );
    }
    return this.token;
  }
  messageRoute(messageId) {
    return import_types12.Routes.webhookMessage(this.id, this.requireToken(), messageId);
  }
};
...
var GuildChannel = class extends Channel {
  ...
  async createWebhook(options) {
    const data = await this.client.rest.post(import_types13.Routes.channelWebhooks(this.id), {
      body: options,
      auth: true
    });
  ...
  async fetchWebhooks() {
    const data = await this.client.rest.get(import_types13.Routes.channelWebhooks(this.id));
  ...
  async createInvite(options) {
    ...
    const data = await this.client.rest.post(import_types13.Routes.channelInvites(this.id), {
  ...
  async fetchInvites() {
    const data = await this.client.rest.get(import_types13.Routes.channelInvites(this.id));
  ...
  async editPermission(overwriteId, options) {
    await this.client.rest.put(import_types13.Routes.channelPermission(this.id, overwriteId), {
      body: options,
      auth: true
    });
    const entry = {
  ...
  async deletePermission(overwriteId) {
    await this.client.rest.delete(import_types13.Routes.channelPermission(this.id, overwriteId), { auth: true });
    const idx = this.permissionOverwrites.findIndex((o) => o.id === overwriteId);
  ...
  canSendMessage() {
    ...
    return perms.has(import_util8.PermissionFlags.ViewChannel) && perms.has(import_util8.PermissionFlags.SendMessages);
  }
  /** Edit this channel's settings. Requires Manage Channels. */
  async edit(options) {
    const data = await this.client.rest.patch(import_types13.Routes.channel(this.id), {
  ...
  async delete(options) {
    ...
    await this.client.rest.delete(import_types13.Routes.channel(this.id) + (qs2 ? `?${qs2}` : ""), {
      body,
      auth: true
    });
...
var GUILD_FACTORIES = {
  [import_types14.ChannelType.GuildText]: (c, d) => new TextChannel(c, d),
  [import_types14.ChannelType.GuildCategory]: (c, d) => new CategoryChannel(c, d),
  [import_types14.ChannelType.GuildVoice]: (c, d) => new VoiceChannel(c, d),
  [import_types14.ChannelType.GuildLink]: (c, d) => new LinkChannel(c, d)
};
var DM_TYPES = /* @__PURE__ */ new Set([
  import_types14.ChannelType.DM,
  import_types14.ChannelType.GroupDM,
  import_types14.ChannelType.DMPersonalNotes
]);
...
var GuildEmoji = class extends Base {
  ...
  get createdTimestamp() {
    return import_util9.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this emoji was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util9.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  ...
  async delete() {
    await this.client.rest.delete(import_types15.Routes.guildEmoji(this.guildId, this.id), {
      auth: true
    });
   ...
   */
  async edit(options) {
    const data = await this.client.rest.patch(import_types15.Routes.guildEmoji(this.guildId, this.id), {
      body: options,
      auth: true
    });
    this.name = data.name;
...
var import_util11 = require("@fluxerjs/util");
...
function computePermissions(basePermissions, overwrites, memberRoles, memberId, isOwner) {
  if (isOwner) return import_util10.ALL_PERMISSIONS_BIGINT;
  let perms = basePermissions;
  for (const overwrite of overwrites ?? []) {
    const applies = overwrite.type === import_types16.OverwriteType.Role && memberRoles.includes(overwrite.id) || overwrite.type === import_types16.OverwriteType.Member && overwrite.id === memberId;
    if (!applies) continue;
    const allow = BigInt(overwrite.allow || "0");
    const deny = BigInt(overwrite.deny || "0");
    perms = perms & ~deny | allow;
  }
  return (perms & import_util10.PermissionFlags.Administrator) !== 0n ? import_util10.ALL_PERMISSIONS_BIGINT : perms;
}
...
var GuildMemberRoleManager = class {
  ...
  get cache() {
    const out = new import_collection5.Collection();
  ...
  async add(roleOrId) {
    ...
    await this.member.client.rest.put(
      import_types17.Routes.guildMemberRole(this.member.guild.id, this.member.id, id)
    );
    this.ids.push(id);
  }
  ...
  async set(roleIds) {
    const data = await this.member.client.rest.patch(
      import_types17.Routes.guildMember(this.member.guild.id, this.member.id),
...
var GuildMember = class _GuildMember extends Base {
  ...
  async edit(options) {
    ...
    const route = isMe ? import_types18.Routes.guildMemberMe(this.guild.id) : import_types18.Routes.guildMember(this.guild.id, this.id);
   ...
   */
  get permissions() {
    return new import_util11.PermissionsBitField(this._effectivePermissions([], []));
  }
  /**
  ...
  permissionsIn(channel) {
    return new import_util11.PermissionsBitField(
...
var import_util12 = require("@fluxerjs/util");
var GuildSticker = class extends Base {
  ...
  get createdTimestamp() {
    return import_util12.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this sticker was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util12.SnowflakeUtil.dateFromSnowflake(this.id);
  }
...
var import_util13 = require("@fluxerjs/util");
var Role = class _Role extends Base {
  ...
  get permissions() {
    ...
    return new import_util13.PermissionsBitField(
      (bits & import_util13.PermissionFlags.Administrator) !== 0n ? import_util13.ALL_PERMISSIONS_BIGINT : bits
    );
  }
  /**
  ...
  get createdTimestamp() {
    return import_util13.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this role was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util13.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  toString() {
    return `<@&${this.id}>`;
  }
  ...
  async edit(options) {
    ...
    const data = await this.client.rest.patch(import_types20.Routes.guildRole(this.guildId, this.id), {
      body: Object.keys(body).length ? body : void 0,
      auth: true
    });
    this._patch(data);
   ...
   */
  async delete() {
    await this.client.rest.delete(import_types20.Routes.guildRole(this.guildId, this.id), { auth: true });
...
// src/ClientCore/ChannelManager.ts
var ChannelManager = class extends import_collection6.LimitedCollection {
  constructor(client) {
    super({
  ...
  async fetch(channelId, options) {
    ...
    try {
      const data = await this.client.rest.get(import_types21.Routes.channel(channelId));
      ...
      if (!channel) {
        throw new import_util3.FluxerError("Channel data invalid or unsupported type", {
          code: import_util2.ErrorCodes.ChannelNotFound
        });
      }
  ...
  async send(channelId, payload) {
    ...
    const data = await this.client.rest.post(
      import_types21.Routes.channelMessages(channelId),
      postPayload
    );
...
var import_types39 = require("@fluxerjs/types");
var import_util20 = require("@fluxerjs/util");

// src/Domain/User.ts
var import_types22 = require("@fluxerjs/types");
var import_util14 = require("@fluxerjs/util");
var User = class extends Base {
  ...
  get createdTimestamp() {
    return import_util14.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this account was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util14.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  toString() {
    return `<@${this.id}>`;
  }
   ...
   */
  async createDM() {
    const data = await this.client.rest.post(import_types22.Routes.userMeChannels(), {
...
var import_types23 = require("@fluxerjs/types");
var import_util15 = require("@fluxerjs/util");
async function resolveClientEmoji(client, emoji, guildId) {
  if (typeof emoji === "object" && emoji.id) {
    return (0, import_util15.formatEmoji)({ name: emoji.name, id: emoji.id, animated: emoji.animated });
  }
  const parsed = (0, import_util15.parseEmoji)(
    typeof emoji === "string" ? emoji : emoji.id ? `:${emoji.name}:` : emoji.name
  );
  if (!parsed) {
    throw new import_util3.FluxerError("Invalid emoji", { code: import_util2.ErrorCodes.InvalidEmoji });
  }
  if (parsed.id) {
    return (0, import_util15.formatEmoji)(parsed);
  }
  if (!/^\w+$/.test(parsed.name)) return parsed.name;
  const unicodeFromShortcode = (0, import_util15.getUnicodeFromShortcode)(parsed.name);
  if (unicodeFromShortcode) return unicodeFromShortcode;
  if (guildId) {
    const emojis = await client.rest.get(import_types23.Routes.guildEmojis(guildId));
    const found = emojis.find((e) => e.name && e.name.toLowerCase() === parsed.name.toLowerCase());
    if (found) return (0, import_util15.formatEmoji)({ ...parsed, id: found.id, animated: found.animated });
    throw new import_util3.FluxerError(
      `Custom emoji ":${parsed.name}:" not found in guild. Use name:id or <:name:id> format.`,
      { code: import_util2.ErrorCodes.EmojiNotFound }
    );
  }
  if (/^\w+$/.test(parsed.name)) {
    throw new import_util3.FluxerError(
      ...
      { code: import_util2.ErrorCodes.EmojiRequiresGuild }
    );
  }
  return parsed.name;
}
async function fetchInstance(client) {
  const raw = await client.rest.get(import_types23.Routes.instanceDiscovery(), { auth: false });
  return parseInstanceDiscovery(raw);
}
function fetchGatewayInfo(client) {
  return client.rest.get(import_types23.Routes.gatewayBot());
}
function fetchEmojiMetadata(client, emojiId) {
  return client.rest.get(import_types23.Routes.emojiMetadata(emojiId), { auth: true });
}
function fetchStickerMetadata(client, stickerId) {
  return client.rest.get(import_types23.Routes.stickerMetadata(stickerId), { auth: true });
}
function fetchApplication(client) {
  return client.rest.get(import_types23.Routes.applicationsMe(), { auth: true });
}
async function fetchOAuthApplications(client) {
  const data = await client.rest.get(import_types23.Routes.oauth2ApplicationsMe(), { auth: true });
  return Array.isArray(data) ? data : data.applications ?? [];
}
function checkUsernameTag(client, username, discriminator) {
  const params = new URLSearchParams({ username, discriminator });
  return client.rest.get(`${import_types23.Routes.checkUsernameTag()}?${params}`, { auth: true });
}
function assertChannelIdBatch(name, channelIds) {
  if (channelIds.length < 1 || channelIds.length > 100) {
    throw new import_util3.FluxerError(`${name} requires between 1 and 100 channel IDs`, {
      code: import_util2.ErrorCodes.InvalidFetchLimit
    });
  }
}
function preloadMessages(client, channelIds) {
  ...
  return client.rest.post(import_types23.Routes.preloadMessages(), {
...
function preloadMessagesAlt(client, channelIds) {
  ...
  return client.rest.post(import_types23.Routes.preloadMessagesAlt(), {
    body: { channels: channelIds },
    auth: true
  });
}
async function bulkFetchMessages(client, requests, options = {}) {
  ...
  const data = await client.rest.post(import_types23.Routes.channelsMessagesBulk(), {
    body: { requests: wire },
    auth: true
  });
  ...
  return {
    channels: data.channels.map((entry) => {
      const collection = new import_collection7.Collection();
...
var import_types33 = require("@fluxerjs/types");
var import_util17 = require("@fluxerjs/util");

// src/ClientCore/GuildMemberManager.ts
var import_collection8 = require("@fluxerjs/collection");
var import_types24 = require("@fluxerjs/types");
var GuildMemberManager = class extends import_collection8.LimitedCollection {
  constructor(guild) {
  ...
  async fetch(options) {
    ...
    if (options?.after) params.set("after", options.after);
    const qs2 = params.toString();
    const url = import_types24.Routes.guildMembers(this.guild.id) + (qs2 ? `?${qs2}` : "");
  ...
  async search(options = {}) {
    const data = await this.guild.client.rest.post(
      import_types24.Routes.guildMembersSearch(this.guild.id),
...
var import_types25 = require("@fluxerjs/types");
...
async function fetchAuditLogs(guild, options) {
  const url = import_types25.Routes.guildAuditLogs(guild.id) + qs({
    limit: options?.limit,
...
async function editGuild(guild, options) {
  const data = await guild.client.rest.patch(import_types25.Routes.guild(guild.id), {
...
async function fetchVanityURL(guild) {
  const data = await guild.client.rest.get(import_types25.Routes.guildVanityUrl(guild.id), {
    auth: true
  });
  return toVanityPayload(data);
}
async function editVanityURL(guild, code) {
  const data = await guild.client.rest.patch(import_types25.Routes.guildVanityUrl(guild.id), {
    body: { code },
    auth: true
  });
...
async function fetchDiscoveryStatus(guild) {
  const data = await guild.client.rest.get(import_types25.Routes.guildDiscovery(guild.id), {
    auth: true
  });
...
async function applyForDiscovery(guild, options) {
  const data = await guild.client.rest.post(
    import_types25.Routes.guildDiscovery(guild.id),
    {
...
async function withdrawDiscoveryApplication(guild) {
  await guild.client.rest.delete(import_types25.Routes.guildDiscovery(guild.id), { auth: true });
}
async function deleteGuild(guild, options) {
  const body = options ? toSudoBody(options) : {};
  await guild.client.rest.post(import_types25.Routes.guildDelete(guild.id), {
    body,
    auth: true
  });
...
async function transferOwnership(guild, newOwnerId, password) {
  await guild.client.rest.post(import_types25.Routes.guildTransferOwnership(guild.id), {
...
var import_types26 = require("@fluxerjs/types");
async function createChannel(guild, data) {
  const created = await guild.client.rest.post(import_types26.Routes.guildChannels(guild.id), {
    body: data,
    auth: true
  });
...
async function fetchChannels(guild) {
  const data = await guild.client.rest.get(import_types26.Routes.guildChannels(guild.id));
  const channels = [];
...
async function setChannelPositions(guild, updates) {
  await guild.client.rest.patch(import_types26.Routes.guildChannels(guild.id), {
    body: toChannelPositionBody(updates),
    auth: true
  });
}
async function fetchWebhooks(guild) {
  const data = await guild.client.rest.get(import_types26.Routes.guildWebhooks(guild.id));
  return data.map((w) => new Webhook(guild.client, w));
}
async function fetchInvites(guild) {
  const data = await guild.client.rest.get(import_types26.Routes.guildInvites(guild.id));
...
var import_types27 = require("@fluxerjs/types");
async function fetchEmojis(guild) {
  const data = await guild.client.rest.get(import_types27.Routes.guildEmojis(guild.id));
  return data.map((e) => cacheEmoji(guild, e));
}
async function fetchEmoji(guild, emojiId) {
  try {
    const data = await guild.client.rest.get(import_types27.Routes.guildEmoji(guild.id, emojiId));
    return cacheEmoji(guild, data);
  } catch (err) {
    rethrowMapped(err, {
      notFound: { code: import_util2.ErrorCodes.EmojiNotFound, message: `Emoji ${emojiId} not found in guild` },
      fallback: "Failed to fetch guild emoji"
    });
  }
}
async function createEmoji(guild, options) {
  const data = await guild.client.rest.post(import_types27.Routes.guildEmojis(guild.id), {
    body: options,
    auth: true
  });
  return cacheEmoji(guild, data);
...
async function cloneEmoji(guild, sourceEmojiId) {
  const data = await guild.client.rest.post(import_types27.Routes.guildEmojisClone(guild.id), {
...
async function createEmojisBulk(guild, emojis) {
  const data = await guild.client.rest.post(
    import_types27.Routes.guildEmojisBulk(guild.id),
...
var import_types28 = require("@fluxerjs/types");
async function fetchMember(guild, userId) {
  try {
    const data = await guild.client.rest.get(
      import_types28.Routes.guildMember(guild.id, userId)
    );
    return cacheMember(guild, data);
  } catch (err) {
    rethrowMapped(err, {
      notFound: {
        code: import_util2.ErrorCodes.MemberNotFound,
...
async function fetchMe(guild) {
  const data = await guild.client.rest.get(
    import_types28.Routes.guildMemberMe(guild.id),
    { auth: true }
  );
  return cacheMember(guild, data);
}
...
var import_types30 = require("@fluxerjs/types");

// src/Domain/Guild/GuildBan.ts
var import_types29 = require("@fluxerjs/types");
var GuildBan = class extends Base {
   ...
   */
  async unban() {
    await this.client.rest.delete(import_types29.Routes.guildBan(this.guildId, this.user.id), {
      auth: true
    });
  }
};
...
async function ban(guild, userId, options) {
  ...
  await guild.client.rest.put(import_types30.Routes.guildBan(guild.id, userId), {
    body: Object.keys(body).length ? body : void 0,
    auth: true
  });
}
async function fetchBans(guild) {
  const data = await guild.client.rest.get(import_types30.Routes.guildBans(guild.id));
  return data.map((b) => new GuildBan(guild.client, { ...b, guild_id: guild.id }, guild.id));
}
async function unban(guild, userId) {
  await guild.client.rest.delete(import_types30.Routes.guildBan(guild.id, userId), { auth: true });
}
async function kick(guild, userId) {
  await guild.client.rest.delete(import_types30.Routes.guildMember(guild.id, userId), { auth: true });
}

// src/Domain/Guild/Roles.ts
var import_types31 = require("@fluxerjs/types");
var import_util16 = require("@fluxerjs/util");
async function createRole(guild, options = {}) {
  const body = toRoleRequestBody(options);
  const data = await guild.client.rest.post(import_types31.Routes.guildRoles(guild.id), {
    body: Object.keys(body).length ? body : void 0,
    auth: true
  });
...
async function fetchRoles(guild) {
  const data = await guild.client.rest.get(import_types31.Routes.guildRoles(guild.id));
  return data.map((r) => cacheRole(guild, r));
}
async function fetchRole(guild, roleId2) {
  try {
    const data = await guild.client.rest.get(import_types31.Routes.guildRole(guild.id, roleId2));
    return cacheRole(guild, data);
  } catch (err) {
    rethrowMapped(err, {
      notFound: { code: import_util2.ErrorCodes.RoleNotFound, message: `Role ${roleId2} not found in guild` },
      fallback: "Failed to fetch guild role"
    });
  }
}
async function resolveRoleId(guild, arg) {
  const parsed = (0, import_util16.parseRoleMention)(arg);
  ...
  const roles = await guild.client.rest.get(import_types31.Routes.guildRoles(guild.id));
...
async function setRolePositions(guild, updates) {
  return replaceRoles(
    guild,
    await guild.client.rest.patch(import_types31.Routes.guildRoles(guild.id), {
      body: updates,
      auth: true
    })
  );
...
async function setRoleHoistPositions(guild, updates) {
  return replaceRoles(
    guild,
    await guild.client.rest.patch(import_types31.Routes.guildRolesHoistPositions(guild.id), {
      body: updates.map((u) => ({
        id: u.id,
...
async function resetRoleHoistPositions(guild) {
  return replaceRoles(
    guild,
    await guild.client.rest.delete(import_types31.Routes.guildRolesHoistPositions(guild.id), {
      auth: true
    })
  );
}
...
var import_types32 = require("@fluxerjs/types");
async function createSticker(guild, options) {
  const data = await guild.client.rest.post(import_types32.Routes.guildStickers(guild.id), {
    body: options,
    auth: true
  });
...
async function cloneSticker(guild, sourceStickerId) {
  const data = await guild.client.rest.post(import_types32.Routes.guildStickersClone(guild.id), {
...
async function createStickersBulk(guild, stickers) {
  const data = await guild.client.rest.post(
    import_types32.Routes.guildStickersBulk(guild.id),
...
async function fetchStickers(guild) {
  const data = await guild.client.rest.get(import_types32.Routes.guildStickers(guild.id));
  return data.map((s) => cacheSticker(guild, s));
}
async function fetchSticker(guild, stickerId) {
  const data = await guild.client.rest.get(import_types32.Routes.guildSticker(guild.id, stickerId));
  return cacheSticker(guild, data);
}
...
var Guild = class extends Base {
  ...
  constructor(client, data) {
    ...
    this.channels = new import_collection9.LimitedCollection({
      maxSize: Number.POSITIVE_INFINITY,
      onEvict: (_id, channel) => client.cache.cascadeChannel(channel, "guild")
    });
    this.roles = new import_collection9.LimitedCollection({ maxSize: client.cache.limits.roles });
    this.emojis = new import_collection9.LimitedCollection({ maxSize: client.cache.limits.emojis });
    this.stickers = new import_collection9.LimitedCollection({ maxSize: client.cache.limits.stickers });
    this.name = data.name ?? "";
    this.icon = data.icon ?? null;
    this.banner = data.banner ?? null;
    ...
    this.nsfwLevel = data.nsfw_level ?? import_types33.GuildNSFWLevel.Safe;
  ...
  _patch(data) {
    ...
    if (data.nsfw_level !== void 0) this.nsfwLevel = data.nsfw_level ?? import_types33.GuildNSFWLevel.Safe;
  ...
  get createdTimestamp() {
    return import_util17.SnowflakeUtil.timestampFromSnowflake(this.id);
  }
  /** Date when this guild was created, derived from its snowflake ID. */
  get createdAt() {
    return import_util17.SnowflakeUtil.dateFromSnowflake(this.id);
  }
  /** The guild's name. */
  toString() {
    return this.name;
...
var import_util18 = require("@fluxerjs/util");
...
function normalizeGuildUpdatePayload(raw) {
  if (!(0, import_util18.isRecord)(raw) || !isValidGuildPayload(raw)) return null;
  return raw;
}
...
var import_types34 = require("@fluxerjs/types");
var ClientUser = class extends User {
  ...
  setPresence(presence) {
    ...
    this.client._sendToAllShards({ op: import_types34.GatewayOpcodes.PresenceUpdate, d: wire });
  }
  /** GET /users/@me — refresh the logged-in user from REST and patch this instance. */
  async fetch() {
    const data = await this.client.rest.get(import_types34.Routes.currentUser(), { auth: true });
    this._patch(data);
    return this;
  }
  /** GET /users/@me/guilds — returns camelCase partial guilds. */
  async fetchGuilds(options) {
    const path = import_types34.Routes.currentUserGuilds() + (options?.withCounts ? "?with_counts=true" : "");
  ...
  async leaveGuild(guildId, options) {
    const body = options ? toSudoBody(options) : void 0;
    await this.client.rest.delete(import_types34.Routes.leaveGuild(guildId), {
      body: body && Object.keys(body).length ? body : void 0,
      auth: true
    });
  }
  ...
  async bulkDeleteMyMessagesInGuild(guildId, options) {
    const body = options ? toSudoBody(options) : void 0;
    await this.client.rest.post(import_types34.Routes.guildBulkDeleteMine(guildId), {
      body: body && Object.keys(body).length ? body : void 0,
      auth: true
    });
  }
...
var import_util19 = require("@fluxerjs/util");
...
var import_types35 = require("@fluxerjs/types");
function normalizeInviteCreate(client, payload) {
  const raw = (0, import_util19.asRecord)(payload);
  const code = (0, import_util19.str)(raw?.code);
  if (!raw || !code) return null;
  const typeNum = (0, import_util19.num)(raw.type);
  const type = typeNum === import_types35.InviteType.GroupDM || typeNum === import_types35.InviteType.EmojiPack || typeNum === import_types35.InviteType.StickerPack ? typeNum : import_types35.InviteType.Guild;
  const shared = {
    code,
    inviter: raw.inviter ?? null,
    member_count: (0, import_util19.num)(raw.member_count),
    expires_at: raw.expires_at ?? void 0,
    temporary: typeof raw.temporary === "boolean" ? raw.temporary : void 0,
    created_at: (0, import_util19.str)(raw.created_at),
    uses: (0, import_util19.num)(raw.uses),
    max_uses: (0, import_util19.num)(raw.max_uses),
    max_age: (0, import_util19.num)(raw.max_age)
  };
  if (type === import_types35.InviteType.EmojiPack || type === import_types35.InviteType.StickerPack) {
    const pack = (0, import_util19.asRecord)(raw.pack);
    if (!pack || !(0, import_util19.str)(pack.id) || !(0, import_util19.str)(pack.name)) return null;
    return { ...shared, type, pack };
  }
  const guildObj = (0, import_util19.asRecord)(raw.guild);
  const channelObj = (0, import_util19.asRecord)(raw.channel);
  const guildId = (0, import_util19.str)(guildObj?.id) ?? (0, import_util19.str)(raw.guild_id) ?? "0";
  const channelId = (0, import_util19.str)(channelObj?.id) ?? (0, import_util19.str)(raw.channel_id) ?? "0";
  ...
  const channel = {
    id: channelId,
    type: (0, import_util19.num)(channelObj?.type) ?? cachedChannel?.type ?? import_types35.ChannelType.GuildText,
    name: (0, import_util19.str)(channelObj?.name) ?? cachedChannel?.name ?? null,
    icon: channelObj?.icon ?? null
  };
  if (type === import_types35.InviteType.GroupDM) return { ...shared, type, channel };
  return {
    ...shared,
    type: import_types35.InviteType.Guild,
    guild: {
      id: guildId,
      name: (0, import_util19.str)(guildObj?.name) ?? cachedGuild?.name ?? "Unknown Guild",
    ...
    channel,
    presence_count: (0, import_util19.num)(raw.presence_count)
  };
}
var inviteHandlers = {
...
async function connectClientGateway(client, token, signal) {
  if (signal?.aborted) {
    throw new import_util3.FluxerError("Connection aborted", { code: import_util2.ErrorCodes.GatewayConnectionAborted });
  }
  const ws = new import_ws.WebSocketManager({
    token,
...
var import_collection10 = require("@fluxerjs/collection");
var import_types36 = require("@fluxerjs/types");
var GuildManager = class extends import_collection10.LimitedCollection {
  constructor(client) {
    super({
  ...
  async fetch(guildId, options) {
    ...
    if (cached && !options?.force) return cached;
    try {
      const data = await this.client.rest.get(import_types36.Routes.guild(guildId));
      if (cached) {
        cached._patch(data);
        return cached;
      }
      ...
      rethrowMapped(err, {
        notFound: { code: import_util2.ErrorCodes.GuildNotFound, message: `Guild ${guildId} not found` },
...
var import_types37 = require("@fluxerjs/types");
...
var PackManager = class {
  ...
  async fetchDashboard() {
    const data = await this.client.rest.get(import_types37.Routes.packs());
    return {
  ...
  async create(packType, body) {
    const data = await this.client.rest.post(import_types37.Routes.packsByType(packType), {
      body
    });
  ...
  async edit(packId, body) {
    const data = await this.client.rest.patch(import_types37.Routes.pack(packId), { body });
    return toPackSummaryPayload(data);
  }
  /** Delete a pack. */
  async delete(packId) {
    await this.client.rest.delete(import_types37.Routes.pack(packId));
  }
  /** Install a pack for the current user. */
  async install(packId) {
    await this.client.rest.post(import_types37.Routes.packInstall(packId));
  }
  /** Uninstall a pack for the current user. */
  async uninstall(packId) {
    await this.client.rest.delete(import_types37.Routes.packInstall(packId));
  }
  /** List invites for a pack. */
  async listInvites(packId) {
    const data = await this.client.rest.get(import_types37.Routes.packInvites(packId));
  ...
  async createInvite(packId, options = {}) {
    ...
    const data = await this.client.rest.post(import_types37.Routes.packInvites(packId), {
      body: Object.keys(body).length ? body : void 0
    });
  ...
  async listEmojis(packId) {
    const data = await this.client.rest.get(import_types37.Routes.packEmojis(packId));
    return data.map(toEmojiPayload);
  }
  /** Create an emoji in a pack. */
  async createEmoji(packId, options) {
    const data = await this.client.rest.post(import_types37.Routes.packEmojis(packId), {
  ...
  async createEmojisBulk(packId, emojis) {
    const data = await this.client.rest.post(
      import_types37.Routes.packEmojisBulk(packId),
  ...
  async editEmoji(packId, emojiId, options) {
    const data = await this.client.rest.patch(import_types37.Routes.packEmoji(packId, emojiId), {
  ...
  async deleteEmoji(packId, emojiId) {
    await this.client.rest.delete(import_types37.Routes.packEmoji(packId, emojiId));
  }
  /** List stickers in a pack. */
  async listStickers(packId) {
    const data = await this.client.rest.get(import_types37.Routes.packStickers(packId));
    return data.map(toStickerPayload);
  }
  /** Create a sticker in a pack. */
  async createSticker(packId, options) {
    const data = await this.client.rest.post(import_types37.Routes.packStickers(packId), {
  ...
  async createStickersBulk(packId, stickers) {
    const data = await this.client.rest.post(
      import_types37.Routes.packStickersBulk(packId),
  ...
  async editSticker(packId, stickerId, options) {
    const data = await this.client.rest.patch(import_types37.Routes.packSticker(packId, stickerId), {
  ...
  async deleteSticker(packId, stickerId) {
    await this.client.rest.delete(import_types37.Routes.packSticker(packId, stickerId));
  }
};

// src/ClientCore/UserManager.ts
var import_collection11 = require("@fluxerjs/collection");
var import_types38 = require("@fluxerjs/types");
var soft = (p) => p.catch(() => null);
var UserManager = class extends import_collection11.LimitedCollection {
  constructor(client) {
  ...
  async fetch(userId) {
    const data = await this.client.rest.get(import_types38.Routes.user(userId));
  ...
  async fetchWithProfile(userId, options) {
    ...
    const [userData, globalProfileRaw, serverProfileRaw, memberData] = await Promise.all([
      this.client.rest.get(import_types38.Routes.user(userId)),
      soft(this.client.rest.get(import_types38.Routes.userProfile(userId))),
      guildId ? soft(this.client.rest.get(import_types38.Routes.userProfile(userId, guildId))) : null,
      guildId ? soft(this.client.rest.get(import_types38.Routes.guildMember(guildId, userId))) : null
    ]);
...
// src/ClientCore/Client.ts
var Client = class _Client extends import_node_events3.EventEmitter {
  ...
  constructor(options = {}) {
    ...
    this.logger = options.logger ?? (0, import_util20.createLogger)({
  ...
  static async fromDiscovery(origin, options = {}, connectOptions) {
    ...
    const bootstrap = new import_rest3.REST({
      ...options.rest ?? {},
      api: bootstrapApi,
      version
    });
    const raw = await bootstrap.get(import_types39.Routes.instanceDiscovery(), {
      auth: false,
  ...
  get ws() {
    if (!this._ws) {
      throw new import_util3.FluxerError("Client is not logged in. Call login() first.", {
        code: import_util2.ErrorCodes.NotLoggedIn
      });
    }
    return this._ws;
  }
  ...
  requestGuildMembers(options) {
    ...
    if (!data.guild_id && !data.guild_ids?.length) {
      throw new import_util3.FluxerError("requestGuildMembers requires guildId or guildIds", {
        code: import_util2.ErrorCodes.InvalidGatewayRequest
      });
    }
    ...
    this._sendToAllShards({ op: import_types39.GatewayOpcodes.RequestGuildMembers, d: data });
  }
  /**
  ...
  async login(token, options) {
    if (this._ws) {
      throw new import_util3.FluxerError("Client is already logged in. Call destroy() first.", {
        code: import_util2.ErrorCodes.AlreadyLoggedIn
      });
    }
    if (typeof token !== "string" || token.trim().length === 0) {
      throw new import_util3.FluxerError("Bot token is required.", { code: import_util2.ErrorCodes.InvalidToken });
    }
  ...
  assertReady() {
    if (!this.isReady()) {
      throw new import_util3.FluxerError(
        ...
        { code: import_util2.ErrorCodes.ClientNotReady }
      );
    }
  }
  static get Routes() {
    return import_types39.Routes;
  }
};
...
function validateId(id) {
  if (typeof id !== "string" || id.trim().length === 0) {
    throw new import_util3.FluxerError("Runtime id must be a non-empty string.", {
      code: import_util2.ErrorCodes.InvalidRuntimeConfig
    });
  }
  return id.trim();
}
function validateToken(token) {
  if (typeof token !== "string" || token.trim().length === 0) {
    throw new import_util3.FluxerError("Each runtime requires its own non-empty bot token.", {
      code: import_util2.ErrorCodes.InvalidRuntimeConfig
    });
  }
  return token;
...
var ClientCluster = class extends import_node_events4.EventEmitter {
  ...
  *runtimeValues() {
  ...
  async add(input) {
    if (this.destroyed) {
      throw new import_util3.FluxerError("ClientCluster has been destroyed.", {
        code: import_util2.ErrorCodes.ClusterDestroyed
      });
    }
    const id = validateId(input.id);
    const token = validateToken(input.token);
    if (this.runtimes.has(id) || this.pending.has(id)) {
      throw new import_util3.FluxerError(`Runtime id "${id}" is already in use.`, {
        code: import_util2.ErrorCodes.DuplicateRuntimeId
      });
    }
    ...
    if (input.client?._ws) {
      throw new import_util3.FluxerError("Prebuilt client is already logged in. Pass an unconnected Client.", {
        code: import_util2.ErrorCodes.RuntimeAlreadyLoggedIn
      });
    }
    ...
    const rt = this.runtimes.get(id);
    if (!rt) {
      throw new import_util3.FluxerError(`Runtime "${id}" failed to start.`, {
        code: import_util2.ErrorCodes.RuntimeNotFound
      });
    }
  ...
  async restart(id, opts) {
    ...
    if (!existing) {
      throw new import_util3.FluxerError(`Runtime "${key}" was not found.`, {
        code: import_util2.ErrorCodes.RuntimeNotFound
      });
    }
    if (existing.build.kind === "prebuilt") {
      throw new import_util3.FluxerError(
        ...
        { code: import_util2.ErrorCodes.RuntimeConflict }
      );
    }
