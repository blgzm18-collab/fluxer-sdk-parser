...
import { ErrorCodes as ErrorCodes2, FluxerError as FluxerError2, resolveColor } from "@fluxerjs/util";
var MAX = {
  title: 256,
  description: 4096,
  fields: 25,
...
function assertMediaUrl(url) {
  ...
  if (!ok) {
    throw new FluxerError2("Invalid embed media URL", { code: ErrorCodes2.InvalidEmbedMediaUrl });
  }
}
...
var EmbedBuilder = class _EmbedBuilder {
  ...
  setURL(url) {
    if (url != null && url !== "" && !URL.canParse(url)) {
      throw new FluxerError2("Invalid embed URL", { code: ErrorCodes2.InvalidEmbedUrl });
    }
   ...
   */
  setColor(color) {
    this.data.color = color === null ? void 0 : typeof color === "number" ? color : resolveColor(color);
    return this;
  }
  /**
